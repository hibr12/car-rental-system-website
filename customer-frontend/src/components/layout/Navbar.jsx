    ...
    <header className="sticky top-0 z-40 w-full glass-panel border-b border-theme bg-theme-primary/80 backdrop-blur-xl transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-11 h-11 rounded-xl bg-blue-600 flex items-center justify-center group-hover:scale-105 transition-transform">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {isAuthenticated ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/register"
                className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-blue-600 text-white hover:bg-blue-700 active:scale-[0.98] transition-all"
              >
                Register
              </Link>
            </div>
