...
class VehicleTransferStatusChanged extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title' => 'Vehicle Transfer Status Changed',
            'message' => 'Vehicle transfer status changed from ' . $this->oldStatus . ' to ' . $this->newStatus . '.',
            'type' => 'vehicle_transfer_status_changed',
