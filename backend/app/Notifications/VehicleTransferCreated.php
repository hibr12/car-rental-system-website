...
class VehicleTransferCreated extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => 'Vehicle transfer requested from ' . ($this->transfer->fromBranch?->name ?? 'unknown') . ' to ' . ($this->transfer->toBranch?->name ?? 'unknown') . '.',
            'type' => 'vehicle_transfer_created',
