...
import { CalendarCheck, Clock, CheckCircle2, XCircle, Car, ArrowRight, User } from 'lucide-react';
...
export const CustomerDashboard = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Welcome Banner */}
      <div className="bg-gradient-to-r from-blue-900/60 via-slate-900 to-slate-900 border border-slate-800 p-8 rounded-3xl flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-xl">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl">
        <div className="flex items-center justify-between pb-4 border-b border-slate-800">
          <div>
            <h3 className="text-lg font-bold text-white">Recent Booking Activity</h3>
            <p className="text-xs text-slate-400">Your recent vehicle reservations</p>
          </div>
          <Link
