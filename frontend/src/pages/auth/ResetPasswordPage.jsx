...
export const ResetPasswordPage = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-6 bg-slate-900 border border-slate-800 p-8 sm:p-10 rounded-3xl shadow-2xl">
        <Link to="/login" className="inline-flex items-center gap-2 text-xs text-slate-400 hover:text-blue-400">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-400">Your new password must be at least 8 characters long.</p>
        </div>
